...
TUNING_MAX_ITERS = 1500  
FINAL_MAX_ITERS  = 10000
GAMMA_LOW = 1e-5  
GAMMA_HIGH = 1
LAMBDA_LOW = 1e-10
LAMBDA_HIGH = 1e-5

N_TRIALS = 30  # Number of trials for hyperparameter tuning
...
SCHEDULE_DEFAULT   = "cosine"  # one of: "none", "cosine", "exponential"
